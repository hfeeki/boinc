...
std::string science_config::print_xml(int full_subtables, int show_ids, int no_refs,const char *tag) const 
{
	...
	void science_config::parse(const SQL_ROW &s) {
	  ...
	  {  
	        strncpy(info_xml,s[26]->c_str(),255);
	        info_xml[254]=0;
	    }
	      }
